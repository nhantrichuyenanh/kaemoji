...
- heavy Japanese-American (💹 why yen? 🏈 appears first when you search "football emoji") and lack of other countries' cultural symbols and references (where are emojis for Vietnamese _bánh mì_, Indian _sari_, or Mayan _Chichén Itzá_?),
...
On mobile, there isn't a perfect kaomoji keyboard app, as far as I'm aware. Gboard, for what it's worth, is a product of Google, which is bound to collect your data. Other "kawaii cute" (tautology lol) kaomoji apps offer unnecessary features like fonts and custom symbol. There are also paid or freemium ones locked behind a paywall. Throughout my research and testing, I've noticed all of them:
